          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            <div className="col-span-1 lg:col-span-1">
              <Link to="/" className="flex items-center gap-3.5 mb-6 group">
                <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-amber-500/60 bg-stone-900 shadow-xl shrink-0 group-hover:scale-105 transition-transform duration-300">
                  <img 
                  ...
                  />
                  <div className="hidden w-full h-full bg-gradient-to-br from-amber-500 to-amber-700 flex items-center justify-center text-white font-serif font-bold text-2xl">
                    RD
                  </div>
                </div>
                <div>
                  <span className="font-serif font-black text-xl tracking-wider text-white block">
                    R.D TEXTILE
                  </span>
                  <span className="text-[10px] uppercase tracking-widest text-amber-500 font-bold mt-0.5 block">
                    Ripan Saree Center
                  </span>
                </div>
              </Link>
